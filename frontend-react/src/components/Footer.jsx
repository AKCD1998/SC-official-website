        ...
        <div className="row">
          <div className="col-md-4 col-sm-6">
            <div className="footer-info">
              ...
              <address>
                <p>
                  19 หมู่ ตำบล บางแก้ว <br /> เมือง สมุทรสงคราม 75000
                </p>
              </address>
              ...
              <ul className="social-icon">
                <li>
                  <a
                    href="https://www.facebook.com/profile.php?id=61585436018154"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/ad_minscgp1989/"
              ...
              <div className="copyright-text">
                <p>Copyright &copy; SC group 1989 co.Ltd</p>
          ...
          <div className="col-md-4 col-sm-6">
            <div className="footer-info">
              ...
              <address>
                <p>086-775-7572, 086-410-1454</p>
                <p>
                  <a href="mailto:youremail.co">scgroup1989.rx@gmail.com</a>
                </p>
              </address>
